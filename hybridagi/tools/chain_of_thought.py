...
class ChainOfThoughtSignature(dspy.Signature):
    ...
    answer = dspy.OutputField(desc = "The right answer")

class ChainOfThoughtTool(BaseTool):

    def __init__(self):
        super().__init__(name = "ChainOfThought")
        self.chain_of_thought = dspy.ChainOfThought(ChainOfThoughtSignature)
